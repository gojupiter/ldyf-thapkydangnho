...
<div class="lahfb-modal-wrap lahfb-modal-edit" data-element-target="contact">
	...
	<div class="lahfb-modal-header">
		<h4><?php esc_html_e( 'Contact Settings', 'lastudio-header-footer-builder' ); ?></h4>
		...
		<div class="lahfb-modal-contents w-row">
			...
			<div class="lahfb-tab-panel lahfb-group-panel" data-id="#general">
				...
				<?php
					...
					// Select Form
					lahfb_contact( array(
						'title'			=> esc_html__( 'Select contact form', 'lastudio-header-footer-builder' ),
						'id'			=> 'contact_form',
					));
					...
					lahfb_select( array(
						...
						'options'		=> array(
							...
							'form' 	=> esc_html__( 'Just Form', 'lastudio-header-footer-builder' ),
						),
						'dependency'	=> array(
                    ...
                    lahfb_textfield( array(
                        'title'			=> esc_html__( 'Contact Text', 'lastudio-header-footer-builder' ),
                        'id'			=> 'contact_text',
                        'default'		=> 'Contact Us',
                    ));
					...
					// Select Open type
					lahfb_select( array(
						'title'			=> esc_html__( 'How to open the form?', 'lastudio-header-footer-builder' ),
						'id'			=> 'open_form',
						'default'		=> 'modal',
						'options'		=> array(
                    ...
                    lahfb_textfield( array(
                        'title'			=> esc_html__( 'Modal Contact Heading', 'lastudio-header-footer-builder' ),
