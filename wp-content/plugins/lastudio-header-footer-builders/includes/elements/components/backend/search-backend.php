<!-- modal search edit -->
<div class="lahfb-modal-wrap lahfb-modal-edit" data-element-target="search">

	<div class="lahfb-modal-header">
		<h4><?php esc_html_e( 'Search Settings', 'lastudio-header-footer-builder' ); ?></h4>
				...
				<?php
					...
					lahfb_select( array(
						...
						'options'		=> array(
							...
							'slide'  => esc_html__( 'Slide (Vertical)', 'lastudio-header-footer-builder' ),
                    ...
                    lahfb_switcher( array(
                        'title'         => esc_html__( 'Is Product Search?', 'lastudio-header-footer-builder' ),
					...
					lahfb_textfield( array(
						'title'			=> esc_html__( 'Placeholder Text', 'lastudio-header-footer-builder' ),
						'id'			=> 'placeholder_text',
						'default'		=> '',
					));
					...
					lahfb_switcher( array(
						'title'			=> esc_html__( 'Hide top arrow?', 'lastudio-header-footer-builder' ),
						'id'			=> 'top_arrow',
						'default'		=> 'false',
					));

					lahfb_switcher( array(
						'title'			=> esc_html__( 'Hide Search box icon?', 'lastudio-header-footer-builder' ),
						'id'			=> 'searchbox_icon',
						'default'		=> 'false',
					));

					lahfb_textfield( array(
						'title'			=> esc_html__( 'Add custom text besides search icon', 'lastudio-header-footer-builder' ),
						'id'			=> 'text_beside_icon',
						'default'		=> 'Search',
					));

					lahfb_textfield( array(
						'title'			=> esc_html__( 'Add custom text before search form', 'lastudio-header-footer-builder' ),
						'id'			=> 'text_before_form',
