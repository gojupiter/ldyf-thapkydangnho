 ...
 *
 * @since       1.0.0
 * @return      global variable ($GLOBALS['lahfb-dynamic-styles'])
 */
function lahfb_styling_tab_output( $atts = array(), $el = '', $class = '', $class_hover = '' ) {
	...
	// Desktop box
	$desktop_style .= ! empty( $margin_top_all ) ? 'margin-top:' . LAHFB_Helper::css_sanatize( $margin_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $margin_right_all ) ? 'margin-right:' . LAHFB_Helper::css_sanatize( $margin_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $margin_bottom_all ) ? 'margin-bottom:' . LAHFB_Helper::css_sanatize( $margin_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $margin_left_all ) ? 'margin-left:' . LAHFB_Helper::css_sanatize( $margin_left_all ) . ';' : '' ;

	$desktop_style .= ! empty( $padding_top_all ) ? 'padding-top:' . LAHFB_Helper::css_sanatize( $padding_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_right_all ) ? 'padding-right:' . LAHFB_Helper::css_sanatize( $padding_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_bottom_all ) ? 'padding-bottom:' . LAHFB_Helper::css_sanatize( $padding_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_left_all ) ? 'padding-left:' . LAHFB_Helper::css_sanatize( $padding_left_all ) . ';' : '' ;

	$desktop_style .= ! empty( $top_left_radius_all ) ? 'border-top-left-radius:' . LAHFB_Helper::css_sanatize( $top_left_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $top_right_radius_all ) ? 'border-top-right-radius:' . LAHFB_Helper::css_sanatize( $top_right_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $bottom_right_radius_all ) ? 'border-bottom-right-radius:' . LAHFB_Helper::css_sanatize( $bottom_right_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $bottom_left_radius_all ) ? 'border-bottom-left-radius:' . LAHFB_Helper::css_sanatize( $bottom_left_radius_all ) . ';' : '' ;
	...
	$desktop_style .= ! empty( $border_top_all ) ? 'border-top-width:' . LAHFB_Helper::css_sanatize( $border_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $border_right_all ) ? 'border-right-width:' . LAHFB_Helper::css_sanatize( $border_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $border_bottom_all ) ? 'border-bottom-width:' . LAHFB_Helper::css_sanatize( $border_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $border_left_all ) ? 'border-left-width:' . LAHFB_Helper::css_sanatize( $border_left_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_top_all ) ? 'top:' . LAHFB_Helper::css_sanatize( $position_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_right_all ) ? 'right:' . LAHFB_Helper::css_sanatize( $position_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_bottom_all ) ? 'bottom:' . LAHFB_Helper::css_sanatize( $position_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_left_all ) ? 'left:' . LAHFB_Helper::css_sanatize( $position_left_all ) . ';' : '' ;
	...
	$gradient_all = lahfb_gradient( $gradient_color1_all, $gradient_color2_all, $gradient_color3_all, $gradient_color4_all, $gradient_direction_all );
	...
	// tablet box
	$tablet_style .= ! empty( $margin_top_tablets ) ? 'margin-top:' . LAHFB_Helper::css_sanatize( $margin_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $margin_right_tablets ) ? 'margin-right:' . LAHFB_Helper::css_sanatize( $margin_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $margin_bottom_tablets ) ? 'margin-bottom:' . LAHFB_Helper::css_sanatize( $margin_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $margin_left_tablets ) ? 'margin-left:' . LAHFB_Helper::css_sanatize( $margin_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $padding_top_tablets ) ? 'padding-top:' . LAHFB_Helper::css_sanatize( $padding_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_right_tablets ) ? 'padding-right:' . LAHFB_Helper::css_sanatize( $padding_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_bottom_tablets ) ? 'padding-bottom:' . LAHFB_Helper::css_sanatize( $padding_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_left_tablets ) ? 'padding-left:' . LAHFB_Helper::css_sanatize( $padding_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $top_left_radius_tablets ) ? 'border-top-left-radius:' . LAHFB_Helper::css_sanatize( $top_left_radius_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $top_right_radius_tablets ) ? 'border-top-right-radius:' . LAHFB_Helper::css_sanatize( $top_right_radius_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $bottom_right_radius_tablets ) ? 'border-bottom-right-radius:' . LAHFB_Helper::css_sanatize( $bottom_right_radius_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $bottom_left_radius_tablets ) ? 'border-bottom-left-radius:' . LAHFB_Helper::css_sanatize( $bottom_left_radius_tablets ) . ';' : '' ;
	...
	$tablet_style .= ! empty( $border_top_tablets ) ? 'border-top-width:' . LAHFB_Helper::css_sanatize( $border_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $border_right_tablets ) ? 'border-right-width:' . LAHFB_Helper::css_sanatize( $border_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $border_bottom_tablets ) ? 'border-bottom-width:' . LAHFB_Helper::css_sanatize( $border_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $border_left_tablets ) ? 'border-left-width:' . LAHFB_Helper::css_sanatize( $border_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $position_top_tablets ) ? 'top:' . LAHFB_Helper::css_sanatize( $position_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_right_tablets ) ? 'right:' . LAHFB_Helper::css_sanatize( $position_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_bottom_tablets ) ? 'bottom:' . LAHFB_Helper::css_sanatize( $position_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_left_tablets ) ? 'left:' . LAHFB_Helper::css_sanatize( $position_left_tablets ) . ';' : '' ;
	...
	$gradient_tablets = lahfb_gradient( $gradient_color1_tablets, $gradient_color2_tablets, $gradient_color3_tablets, $gradient_color4_tablets, $gradient_direction_tablets );
	...
	// mobiles box
	$mobile_style .= ! empty( $margin_top_mobiles ) ? 'margin-top:' . LAHFB_Helper::css_sanatize( $margin_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $margin_right_mobiles ) ? 'margin-right:' . LAHFB_Helper::css_sanatize( $margin_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $margin_bottom_mobiles ) ? 'margin-bottom:' . LAHFB_Helper::css_sanatize( $margin_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $margin_left_mobiles ) ? 'margin-left:' . LAHFB_Helper::css_sanatize( $margin_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $padding_top_mobiles ) ? 'padding-top:' . LAHFB_Helper::css_sanatize( $padding_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_right_mobiles ) ? 'padding-right:' . LAHFB_Helper::css_sanatize( $padding_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_bottom_mobiles ) ? 'padding-bottom:' . LAHFB_Helper::css_sanatize( $padding_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_left_mobiles ) ? 'padding-left:' . LAHFB_Helper::css_sanatize( $padding_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $top_left_radius_mobiles ) ? 'border-top-left-radius:' . LAHFB_Helper::css_sanatize( $top_left_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $top_right_radius_mobiles ) ? 'border-top-right-radius:' . LAHFB_Helper::css_sanatize( $top_right_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $bottom_right_radius_mobiles ) ? 'border-bottom-right-radius:' . LAHFB_Helper::css_sanatize( $bottom_right_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $bottom_left_radius_mobiles ) ? 'border-bottom-left-radius:' . LAHFB_Helper::css_sanatize( $bottom_left_radius_mobiles ) . ';' : '' ;
	...
	$mobile_style .= ! empty( $border_top_mobiles ) ? 'border-top-width:' . LAHFB_Helper::css_sanatize( $border_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $border_right_mobiles ) ? 'border-right-width:' . LAHFB_Helper::css_sanatize( $border_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $border_bottom_mobiles ) ? 'border-bottom-width:' . LAHFB_Helper::css_sanatize( $border_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $border_left_mobiles ) ? 'border-left-width:' . LAHFB_Helper::css_sanatize( $border_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $position_top_mobiles ) ? 'top:' . LAHFB_Helper::css_sanatize( $position_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_right_mobiles ) ? 'right:' . LAHFB_Helper::css_sanatize( $position_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_bottom_mobiles ) ? 'bottom:' . LAHFB_Helper::css_sanatize( $position_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_left_mobiles ) ? 'left:' . LAHFB_Helper::css_sanatize( $position_left_mobiles ) . ';' : '' ;
	...
	$gradient_mobiles = lahfb_gradient( $gradient_color1_mobiles, $gradient_color2_mobiles, $gradient_color3_mobiles, $gradient_color4_mobiles, $gradient_direction_mobiles );
	...
	if(!$is_header_area){
        ...
        if( $atts['current_screen'] == 'desktop-view' ){
            return $styles;
        }
        if( $atts['current_screen'] == 'tablets-view' ){
            return $tablet_styles;
        }
        if( $atts['current_screen'] == 'mobiles-view' ){
