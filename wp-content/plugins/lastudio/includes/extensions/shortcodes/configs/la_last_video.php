...
$shortcode_params = array(
    ...
    array(
        'type'       => 'autocomplete',
        'heading'    => __( 'Tag Not In:', 'lastudio' ),
    ...
    array(
        'type'       => 'autocomplete',
        'heading'    => __( 'Video In:', 'lastudio' ),
        'param_name' => 'video__in',
        'settings'   => array(
            'unique_values'  => true,
            'multiple'       => true,
            'sortable'       => true,
    ...
    array(
        'type'       => 'autocomplete',
        'heading'    => __( 'Video Not In:', 'lastudio' ),
        'param_name' => 'video__not_in',
        'settings'   => array(
            'unique_values'  => true,
            'multiple'       => true,
            'sortable'       => true,
...
return apply_filters(
    ...
    array(
        'name'			=> __('Last Video', 'lastudio'),
        'base'			=> 'la_last_video',
        'icon'          => 'dashicons-before dashicons-format-video',
        'category'  	=> __('La Studio', 'lastudio'),
        'description' 	=> __('The last videos from your video gallery', 'lastudio'),
