					...
					<div class="tc-wiz-screen-half tc-standalone-tickera">
						...
						<label for="tc-woocommerce"><span></span>
							...
							<p>
								<?php
								if ( !tc_iw_is_wl() ) {
									printf( __( 'With more than 100.000.000 downloads, %1$sWooCommerce%2$s is certainly the most popular e-commerce system for the WordPress platform. %3$sBridge for WooCommerce%2$s add-on is required for this mode. You can install it later.', 'tc' ), '<a href="https://woocommerce.com/" target="_blank">', '</a>', '<a href="https://tickera.com/addons/bridge-for-woocommerce/?utm_source=plugin&utm_medium=upsell&utm_campaign=wizard" target="_blank">' );
