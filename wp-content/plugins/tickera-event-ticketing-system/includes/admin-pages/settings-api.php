        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <form action="" method="post" enctype = "multipart/form-data">
                        ...
                        <?php foreach ( $fields as $field ) : ?>
                            <?php if ( $api_keys->is_valid_api_key_field_type( $field['field_type'] ) ) : ?>
                                ...
                                <tr valign="top">
                                    ...
                                    <th scope="row">
                                        <label for="<?php echo $field['field_name']; ?>"><?php echo $field['field_title']; ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if ( 'function' == $field['field_type'] ) : ?>
                                            ...
                                            if ( 'event_name' == $field['field_name'] ) {
                                                eval( $field['function'] . '("' . $field['field_name'] . '"' . ( isset( $post_id ) ? ',' . $post_id : ', ""' ) . ', true );' );
                    ...
                    <?php submit_button( ( isset( $_REQUEST['action'] ) && 'edit' == $_REQUEST['action'] ? __( 'Update', 'tc' ) : __( 'Add New', 'tc' ) ), 'primary', 'add_new_api_key', false ); ?>
                    <?php if ( isset( $_GET['action'] ) && 'edit' == $_GET['action'] ) { ?><a href="<?php echo $settings_api_url; ?>" class="add-new-h2 tc-tickera-secondary"><?php _e( 'Cancel', 'tc' ); ?></a><?php } ?>
                    <div class="clear"></div>
    ...
    <div id="poststuff" class="metabox-holder tc-api-keys">
        <div class="postbox">
            ...
            <table cellspacing="0" class="widefat shadow-table">
                        ...
                        <?php foreach ( $columns as $key => $col ) : ?>
                            ...
                            <?php else : ?>
                                <td>
                                    ...
                                    echo ( isset( $post_field_type ) && 'post_meta' == $post_field_type )
                ...
                <?php if ( count( $wp_api_keys_search->get_results() ) == 0 ) : ?>
                    <tr>
