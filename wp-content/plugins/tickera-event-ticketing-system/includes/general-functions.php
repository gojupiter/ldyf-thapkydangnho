...
function tc_get_ticket_instance_event( $field_name, $field_id, $ticket_instance_id ) {
...
function tc_get_ticket_instance_event_front( $field_name, $field_id, $ticket_instance_id ) {
    $ticket_type_id = get_post_meta($ticket_instance_id, 'ticket_type_id', true);
    $ticket_type = new TC_Ticket($ticket_type_id);
    $event_id = $ticket_type->get_ticket_event(apply_filters('tc_ticket_type_id', $ticket_type_id));
    if (!empty($event_id)) {
 ...
 * @return string
 */
function tc_get_order_details_email( $order_id, $order_key, $return, $status ) {
    global $tc;
