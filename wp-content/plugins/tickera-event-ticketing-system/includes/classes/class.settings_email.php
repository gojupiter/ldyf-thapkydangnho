        ...
        function get_settings_email_sections() {
            ...
            return apply_filters( 'tc_settings_email_sections', array(
                    ...
                    array(
                        ...
                        'title' => __('Admin Order Refunded E-Mail'),
                        'description' => '',
                    ),
                    array(
                        'name' => 'misc_email',
        ...
        function get_settings_email_fields() {
            ...
            $client_order_completed_email_fields = apply_filters( 'client_order_completed_email_fields', array(
                    ...
                    array(
                        ...
                        'field_description' => sprintf(__('Body of the e-mail. You can use following placeholders (%s)', 'tc'), apply_filters('tc_client_order_completed_message_placeholders_description', 'ORDER_ID, ORDER_TOTAL, DOWNLOAD_URL, BUYER_NAME. ORDER_DETAILS, EVENT_NAME, EVENT_LOCATION')),
                        'section' => 'client_order_completed_email',
                        'conditional' => array(
                            'field_name' => 'client_send_message',
                            'field_type' => 'radio',
            ...
            $attendee_order_completed_email_fields = apply_filters( 'attendee_order_completed_email_fields', array(
                    ...
                    array(
                        ...
                        'field_title' => __('Enable Attachment', 'tc'),
                        'field_type' => 'function',
                        'function' => 'tc_yes_no_email',
                        'default_value' => 'no',
                        'tooltip' => __('Attach ticket file rather than inserting a downloadable link.', 'tc'),
                        'section' => 'attendee_order_completed_email',
                        'conditional' => array(
                            'field_name' => 'attendee_send_message',
                            'field_type' => 'radio',
                    ...
                    array(
                        ...
                        'field_description' => sprintf(__('Body of the e-mail. You can use following placeholders (%s)', 'tc'), apply_filters('tc_attendee_order_completed_message_placeholders_description', 'DOWNLOAD_URL, EVENT_NAME, TICKET_TYPE, FIRST_NAME, LAST_NAME, EVENT_LOCATION')),
                        'section' => 'attendee_order_completed_email',
                        'conditional' => array(
                            'field_name' => 'attendee_send_message',
                            'field_type' => 'radio',
            ...
            $admin_order_refunded_email_fields = apply_filters( 'admin_order_refunded_email_fields', array(
                    ...
                    array(
                        ...
                        'function' => 'tc_yes_no_email',
                        'default_value' => 'yes',
                        'tooltip' => __('Whether to send or not e-mail upon each refunded order', 'tc'),
                    ...
                    array(
                        ...
                        'field_title' => __('Subject', 'tc'),
                        'field_type' => 'option',
                        'default_value' => __('Order Refunded', 'tc'),
                        'tooltip' => __('Subject of the e-mail', 'tc'),
                        'section' => 'admin_order_refunded_email',
                        'conditional' => array(
                            'field_name' => 'admin_send_refunded_message',
                    ...
                    array(
                        ...
                        'field_type' => 'function',
                        'function' => 'tc_get_admin_order_message',
                        'default_value' => 'Hello, <br /><br />An order (ORDER_ID) totalling <strong>ORDER_TOTAL</strong> has been refunded. <br /><br />You can check the order details here ORDER_ADMIN_URL',
                        'field_description' => __('Body of the e-mail. You can use following placeholders (ORDER_ID, ORDER_TOTAL, ORDER_ADMIN_URL, BUYER_NAME, ORDER_DETAILS)', 'tc'),
                        'section' => 'admin_order_refunded_email',
                        'conditional' => array(
                            'field_name' => 'admin_send_refunded_message',
