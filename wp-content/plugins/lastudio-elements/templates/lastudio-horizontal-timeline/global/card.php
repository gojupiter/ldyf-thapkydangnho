...
<div class="lastudio-hor-timeline-item__card">
	<div class="lastudio-hor-timeline-item__card-inner">
		...
		echo $this->__loop_item( array( 'item_title' ) , '<' . $title_tag .' class="lastudio-hor-timeline-item__card-title">%s</' . $title_tag . '>' );
		echo $this->__loop_item( array( 'item_desc' ), '<div class="lastudio-hor-timeline-item__card-desc">%s</div>' );
		?>
	</div>
	<?php if ( $show_arrow ) { ?>
