...
class Module extends Module_Base {
	...
	public function ajax_posts_filter_autocomplete( array $data ) {
		...
		switch ( $data['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'lastudio-elements/query_control/get_autocomplete/' . $data['filter_type'], [], $data );
		} // End switch().
	...
	public function ajax_posts_control_value_titles( $request ) {
		...
		switch ( $request['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'lastudio-elements/query_control/get_value_titles/' . $request['filter_type'], [], $request );
		}
	...
	public static function get_query_args( $control_id, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'lastudio-elements/query_control/get_query_args/current_query', $current_query_vars );
