<?php
namespace Lastudio_Elements\Modules\ImageComparison\Widgets;
 ...
 */
class Image_Comparison extends Lastudio_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Image Comparison', 'lastudio-elements' );
    }
    ...
    public function get_style_depends() {
        return array( 'lastudio-juxtapose-css' );
    }

    protected function _register_controls() {
        $css_scheme = apply_filters(
            'lastudio-elements/image-comparison/css-scheme',
            array(
        ...
        $repeater->add_control(
            'item_before_label',
            array(
                'label'   => esc_html__( 'Before Label', 'lastudio-elements' ),
        ...
        $repeater->add_control(
            'item_after_label',
            array(
                'label'   => esc_html__( 'After Label', 'lastudio-elements' ),
                'type'    => Controls_Manager::TEXT,
            )
        );
            ...
            array(
                ...
                'default'     => array(
                    array(
                        ...
                        'item_after_label' => esc_html__( 'After', 'lastudio-elements' ),
        ...
        $this->start_controls_tab(
            'tab_label_before',
            array(
                'label' => esc_html__( 'Before', 'lastudio-elements' ),
            )
        );
        ...
        $this->start_controls_tab(
            'tab_label_after',
            array(
                'label' => esc_html__( 'After', 'lastudio-elements' ),
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Handle', 'lastudio-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Control Width', 'lastudio-elements' ),
        ...
        $this->add_control(
            'handle_arrow_color',
            array(
                'label' => esc_html__( 'Arrow Color', 'lastudio-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Handle Divider', 'lastudio-elements' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Divider Width', 'lastudio-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array( 'px' ),
                'range'      => array(
                    'px' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Divider Color', 'lastudio-elements' ),
                'type'    => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'starting_position',
            array(
                'label'      => esc_html__( 'Divider Starting Position', 'lastudio-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array( '%' ),
                'range'      => array(
                    '%' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Handle Arrow', 'lastudio-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
