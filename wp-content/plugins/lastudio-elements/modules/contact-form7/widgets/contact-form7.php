<?php
namespace Lastudio_Elements\Modules\ContactForm7\Widgets;
 ...
 */
class Contact_Form7 extends Lastudio_Widget {
    ...
    public function get_title() {
        return esc_html__( 'Contact Form 7', 'lastudio-elements' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_settings',
            array(
                'label' => esc_html__( 'Form', 'lastudio-elements' ),
            )
        );
        ...
        $this->add_control( 'form_shortcode', array(
            'label'   => esc_html__( 'Select Form', 'lastudio-elements' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => sprintf(
                    esc_html__( 'In case you want to create the more complex contact form layout, please, feel free to use %s tool', 'lastudio-elements' ),
                    '<a target="_blank" href="https://crocoblock.com/contact-form-7-layout-builder/">' . esc_html__( 'Contact Form 7 Layout Builder', 'lastudio-elements' ) . '</a>'
                )
            )
        );
        ...
        $this->start_controls_section(
            'section_text_style',
            array(
                'label'      => esc_html__( 'Form Texts', 'lastudio-elements' ),
        ...
        $this->add_control(
            'invalid_heading',
            array(
                'label'     => esc_html__( 'Not Valid Notices', 'lastudio-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Controls', 'lastudio-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Placeholder Color', 'lastudio-elements' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->start_controls_tab(
            'tab_input_invalid',
            array(
                'label' => esc_html__( 'Not Valid', 'lastudio-elements' ),
            )
        );
        ...
        $this->add_responsive_control(
            'textarea_min_height',
            array(
                'label'       => esc_html__( 'Textarea Minimal Height', 'lastudio-elements' ),
                'label_block' => true,
        ...
        $this->add_control(
            'arrows',
            array(
                'label'        => esc_html__( 'Fullwidth Button', 'lastudio-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Alerts', 'lastudio-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'sent_heading',
            array(
                'label'     => esc_html__( 'Sent Success', 'lastudio-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'error_heading',
            array(
                'label'     => esc_html__( 'Sent Error', 'lastudio-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'spam_heading',
            array(
                'label'     => esc_html__( 'Spam Blocked', 'lastudio-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
