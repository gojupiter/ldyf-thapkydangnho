<?php
namespace Lastudio_Elements\Modules\Timeline\Widgets;
 ...
 * Timeline Widget
 */
class Timeline extends Lastudio_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Vertical Timeline', 'lastudio-elements' );
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'lastudio-elements/timeline/css-scheme',
            array(
        ...
        $this->add_control(
            'animate_cards',
            array(
                'label'        => esc_html__( 'Animate Cards', 'lastudio-elements' ),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            'horizontal_space',
            array(
                'label'      => esc_html__( 'Horizontal Space', 'lastudio-elements' ),
        ...
        $this->add_responsive_control(
            'vertical_space',
            array(
                'label'      => esc_html__( 'Vertical Space', 'lastudio-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
    ...
    public function _control_section_card_content( $css_scheme ) {
        ...
        $this->add_control(
            'card_arrow_heading',
            array(
                'label'     => esc_html__( 'Card Arrow', 'lastudio-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
        ...
        $this->add_responsive_control(
            'card_arrow_offset',
            array(
                'label'      => esc_html__( 'Card Arrow Offset', 'lastudio-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                    '%',
    ...
    public function _control_section_line( $css_scheme ) {
        ...
        $this->add_responsive_control(
            'line_width',
            array(
                'label'      => esc_html__( 'Thickness', 'lastudio-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
