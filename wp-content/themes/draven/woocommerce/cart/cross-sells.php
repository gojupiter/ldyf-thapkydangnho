...
<?php
	...
	$product_cols = shortcode_atts(
		...
		Draven()->settings()->get('crosssell_products_columns')
	);
	...
	$title = Draven()->settings()->get('crosssell_product_title') ? Draven()->settings()->get('crosssell_product_title') : _x( 'You may be interested in&hellip;', 'front-view', 'draven' );
	$sub_title = Draven()->settings()->get('crosssell_product_subtitle') ? Draven()->settings()->get('crosssell_product_subtitle') : '';
