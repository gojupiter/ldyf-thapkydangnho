...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Draven()->settings()->get('related_products_columns')
	);
	...
	$title = Draven()->settings()->get('related_product_title') ? Draven()->settings()->get('related_product_title') : _x( 'Related Products', 'front-view', 'draven' );
	$sub_title = Draven()->settings()->get('related_product_subtitle') ? Draven()->settings()->get('related_product_subtitle') : '';
